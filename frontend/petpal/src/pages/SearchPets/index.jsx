...
const Pets = () => {
	...
	useEffect(() => {
		async function fetchPets() {
			...
			const response = await fetch(`http://localhost:8000/petlistings/pets?p=${page}&page_size=6&status=all&ordering=${ordering}&shelter=${shelter}&species=${species}&status=${status}&gender=${gender}&breed=${breed}`, {
				method: 'GET',
				headers: {
